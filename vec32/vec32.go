// Package vec32 operates on three-dimensional float32 vectors.
package vec32
...
func (v Vector) Abs() Vector {
	return Vector{float32(math.Abs(float64(v[0]))), float32(math.Abs(float64(v[1]))), float32(math.Abs(float64(v[2])))}
}
...
func (v Vector) GoString() string {
	return fmt.Sprintf("vec32.Vector{%#v, %#v, %#v}", v[0], v[1], v[2])
}
